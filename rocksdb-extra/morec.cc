...
extern "C" {
  void rocksdb_options_set_myrocks_comparator(rocksdb_options_t* opt) {
    rocksdb_options_set_comparator(opt, (rocksdb_comparator_t*)new myrocks::Rdb_pk_comparator);
  }

  void rocksdb_options_set_rev_myrocks_comparator(rocksdb_options_t* opt) {
    rocksdb_options_set_comparator(opt, (rocksdb_comparator_t*)new myrocks::Rdb_rev_comparator);
  }
